...
colnames(resl_mfs_bleo)[grep("IRF7", 
                             colnames(resl_mfs_bleo))]

output["REACTOME_TRAF6_MEDIATED_IRF7_ACTIVATION", ]
```
...
# cd44 is involved in
cd44_pways <- c("REACTOME_NEGATIVE_REGULATION_OF_FLT3",
                "REACTOME_FLT3_SIGNALING",
                "REACTOME_DOWNREGULATION_OF_ERBB4_SIGNALING",
